...
# valori default dei parametri
    configfilepath = "./"
    configfile     = 'AstroPlano2L2T2.cfg'
...
# sensori  pressione, temperatura, umidita' relativa
    ...
    V_values    = [None]*4   # lettura tensioni
